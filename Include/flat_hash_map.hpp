...
namespace ska
{
    ...
    namespace detailv3
    {
        ...
        public:
            ...
            {
                size_t index = hash_policy.index_for_hash(hash_object(key, hash_shr_bits), num_slots_minus_one);
            ...
            {
                return hash_policy.index_for_hash(hash_object(key, hash_shr_bits), num_slots_minus_one);
            }
            ...
            void set_hash_shr_bits(const int _the_shr_bits) {
        ...
        private:
            ...
            template<typename U>
            size_t hash_object(const U& key, int shr_bits)
            {
                return static_cast<Hasher&>(*this)(key) >> shr_bits;
            }
            template<typename U>
            size_t hash_object(const U& key, int shr_bits) const
            {
                return static_cast<const Hasher&>(*this)(key) >> shr_bits;
            }
